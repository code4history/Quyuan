  ...
  features: [
    {
      properties: {
        images: [
          ...
          { imageUrl: "./1.png", thumbnailUrl: "./1.png", imageType: "panorama" },
...
const templates = {
  main: `
    <qy-swiper style='height: 300px'>
      {% for image in images %}
        <qy-swiper-slide imageUrl="{{ image.imageUrl }}" thumbnailUrl="{{ image.thumbnailUrl }}" imageType="{{ image.imageType }}"></qy-swiper-slide>
      {% endfor %}
    </qy-swiper>
  `
};
